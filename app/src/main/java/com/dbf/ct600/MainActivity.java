...
public class MainActivity extends AppCompatActivity
{
    ...
    public void masterOnClicked(View v) { runCommand("0", true); }
    ...
    public class AsyncCommand extends AsyncTask
    {
        ...
        public boolean runCommand()
        {
            ...
            try (Socket socket = new Socket(IP, PORT))
            {
                ...
                {
                    Log.d("CT600 Boombox", "Response: " + readResponse(outputLineBuilder, reader));
                    Log.d("CT600 Boombox", "Sending command: " + command);
            ...
            {
                Log.e("CT600 Boombox", "Failed to send command: "+ command,e);
                return false;
            }
            return true;
        }
